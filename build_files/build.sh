...
dnf5 install -y zsh git git-lfs gum glow fzf lf micro tmux btop rsync restic rclone syncthing hugo godot chibi-scheme chez-scheme sbcl papirus-icon-theme 
